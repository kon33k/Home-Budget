...
import com.kon.budget.service.download.DownloadService;
...
public class DownloadController {
    ...
    public void getDownloadAssets(HttpServletResponse response) {
        downloadService.getFileToDownload(response,
    ...
    public void getDownloadFilteredAssets(HttpServletResponse response,
    ...
    public void getDownloadFilteredExpenses(HttpServletResponse response,
                                            @RequestParam Map<String, String> filter) {
        downloadService.getFileToDownload(response,
                DownloadSpecificationEnum.EXPENSES,
                filter);
